	...
	public void onCreate() {
		...
		runnable = new Runnable() {
			...
			public void run() {
				...
				sendBroadcastToActivity(MainActivity.BROADCAST_TTS_ACTION, MainActivity.TTS_STARTED, false);
			}
		};
//		timer = new Timer();
...
//
	...
	public int onStartCommand(Intent intent, int flags, int startId) {
		...
		if(intent!=null && intent.hasExtra("str")&&isInit){
			String str = intent.getStringExtra("str");
			sendBroadcastToActivity(MainActivity.BROADCAST_TTS_ACTION, MainActivity.TTS_STARTED, true);
