...
public  class RightSprite{
	...
	// number of coordinates per vertex in this array88
	static final int COORDS_PER_VERTEX = 2;
	static float spriteCoords[] = {
			0.0f, -0.65f,   // top left
			-1.0f, -0.65f,   // bottom left
			0.0f, 0.65f,   // bottom right
			-1.0f, 0.65f  }; //top right
	...
	public RightSprite(final Context activityContext){
...
//				Bitmap croppedBitmap = Bitmap.createBitmap(bmpScreen, 0, 0,bmpScreen.getWidth(),bmpScreen.getHeight());
